...
- in a number of cases, content-level similarities are often derived directly from audience composition -- eg, \% of audience who follows trump on twitter, voted republican in last election; which assumes that differences at the level of content are one-in-the-same with differences in audience. some work has gone beyond this, namely work via MC -- chuang et al with topic models in articles, Benkler with analysis of issues during 2016 election; and, long tradition of content analysis in media studies / polisci, though usually vis-a-vis specific issues and relatively small datasets.

- generally, though, less is known, empirically about content graph than audience graph. or, at least -- knowledge about content graph is less precise. one reason for this, perhaps, is that measuring textual distance is fundamentally more complex and open-ended than measuring audience similarity / overlap, where a literal multiple-membership structure can be directly analyzed. whereas with text, Underwood notes, the question how scoring the similarity between two pieces of text is a strand that unravels into a large and complex question.
