...
An immediate question arises from this, though -- how "new" or "old" are the relationships that emerge in these two graphs

This initial contextualization of the content graph, though, also immediately suggests


So far, though, we've been treating the headlines as a completely synchronic slice of data -- we're rolling up 625 days of data into a single unit
