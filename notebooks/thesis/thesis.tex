...
- AP is somewhat of a special case, due to direct syndication. beyond this, most misaligned outlet is Hill, which, in many ways, has the weirdest mix of CA similarities, and seems to be the closest thing to a legitimately bipartisan / cross-partisan outlet
- both high content and audience overlap with MSNBC, but breaks down after that -- high audience overlap with left-leaning WaPo, HuffPo, but low headline similarity; and, high headline sim with (far) right-leaning BB/DC
