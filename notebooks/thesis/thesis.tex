...
How different, in a very precise sense, is a piece of content from Fox vs NYT? or, NYT vs WSJ, WSJ vs WaPo, WaPo vs Breitbart? to what degree do different news outlets focus on different issues, "speak" in different ways?
this question of the separability of news content cuts to heart of recent concerns of processes of fragmentation / polarization in media ecosystem, which tend to invovle an interplay of audience graph and content graph
...
but, how true is this actually? how linked are content and audience? when one changes, does the other follow suit? where does this break down?
...
formualte the question as a supervised learning problem, in which classifiers that predict outlet given headline, which makes it possible to induce high-quality distributed representations of hls, and also makes it possible to very precisely quantify the degree to which different outlets produce similar and dissimilar content.
